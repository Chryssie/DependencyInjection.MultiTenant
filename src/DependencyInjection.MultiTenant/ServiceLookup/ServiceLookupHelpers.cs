...
namespace Microsoft.Extensions.DependencyInjection.ServiceLookup
{
    internal static class ServiceLookupHelpers {
        ...
        internal static readonly MethodInfo CaptureDisposableMethodInfo = typeof(MultiTenantProviderEngineScope)
            .GetMethod(nameof(MultiTenantProviderEngineScope.CaptureDisposable), LookupFlags)!;
